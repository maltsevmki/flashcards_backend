...
def create_test_apkg(output_path: str):
    ...
    notes_data = [
        ...
        (1, "abc1", 1234, "python basics",
         "What is Python?\x1fA high-level programming language", 1234567890),
        (2, "abc2", 1234, "python oop",
         "What is a class?\x1fA blueprint for creating objects", 1234567890),
        (3, "abc3", 1234, "javascript web",
         "What is JavaScript?\x1fA scripting language for web browsers", 1234567890),
        (4, "abc4", 1235, "python advanced",
         "What is a decorator?\x1fA function that modifies another function\x1fUsed with @ syntax",
         1234567890),
        (5, "abc5", 1234, "spanish",
         "Hello\x1fHola", 1234567891),
        (6, "abc6", 1234, "spanish",
         "Goodbye\x1fAdios", 1234567891),
        (7, "abc7", 1234, "cloze-test",
         "The capital of {{c1::France}} is {{c2::Paris}}\x1f(Cloze card)", 1234567890),
        (8, "abc8", 1234, "html-test",
         "<b>Bold question</b>\x1f<i>Italic answer</i>", 1234567890),
    ]
    ...
    print("  - 3 decks: Default, Programming, Languages")
    print("  - 8 notes with various tags and content")
    print("  - Includes: cloze card, HTML card, extra fields")
